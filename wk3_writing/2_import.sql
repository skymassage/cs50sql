...
-- Note that here we don't need the double quotes "" for collections, i.e., there is no need to set "collections",
-- because this is a SQLite statement not a SQL statement.
...
-- and "delimiter ;" changes the delimiter back to ';' after the entire statement.
...
-- Or if the delted item has been delted again, the error message will be raised using "SIGNAL SQLSTATE '45000'".

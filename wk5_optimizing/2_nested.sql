...
-- A covering index means that the data column of the select can be obtained only from the index, 
-- without reading it from the data table. In other words, the query column should be covered by the index used.
...
--                                             a covering index means that we do our search in one step 
